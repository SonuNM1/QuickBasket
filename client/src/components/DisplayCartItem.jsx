        ...
        <div className='bg-white w-full max-w-sm min-h-screen max-h-screen ml-auto'>
            ...
            <div className='min-h-[75vh] lg:min-h-[80vh] h-full max-h-[calc(100vh-150px)] bg-blue-50 p-2 flex flex-col gap-4'>
...

                {
                    cartItem[0] ? (
                        <>        
                            <div className='flex items-center justify-between px-4 py-2 bgblue-100 text-blue-500 rounded-full'>
                                    ...
                                    cartItem[0] && (
                                        cartItem.map((item, index)=> {
                                            return (
                                                ...
                                                <div className='w-16 h-16 min-h-16 max-h-16 bg-red-500 border rounded'>
                                                        <img
                      ...
                      <div className='bg-whiteflex flex-col justify-center items-center'>
                        ...
                        onClick={close}
                        to={'/'}
                         className='block bg-green-600 px-4 py-2 text-white rounded'>Shop Now</Link>
                      </div>  
                    )
                }
