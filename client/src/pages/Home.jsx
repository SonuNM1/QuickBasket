...
import bannerMobile from "../assets/banner-mobie.jpg";
    ...
    <section className="bg-white">
      ...
      <div className="container mx-auto">
        ...
        >
          ...
          <img
            src={bannerMobile}
            className="w-full h-full hidden lg:hidden"
            alt="banner-mobile"
          />
        </div>
      </div>

      <div className="container mx-auto px-4 my-2 grid grid-cols-2 md:grid-cols-8 lg:grid-cols-10 gap-2">
        {
          loadingCategory ? (
          ...
          return (
            ...
            className="bg-white rounded p-4 min-h-36 grid gap-4 shadow animate-pulse">
